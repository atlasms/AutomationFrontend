define(['jquery', 'underscore', 'backbone', 'template', 'config', 'global', 'inbox.model', 'toolbar', 'toastr', 'pdatepicker', 'bootstrap-table'
    ...
    var CrawlLogsView = Backbone.View.extend({
        playerInstance: null
        , toolbar: [
        ...
        , load: function (extend) {
            var params = {query: 'externalid=0&kind=5&provider=inbox'};
        ...
        , render: function (params) {
            ...
            var params = {query: 'externalid=0&kind=5&provider=log'};
