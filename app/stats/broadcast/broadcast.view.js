...
], function ($, _, Backbone, Template, Config, Global, MediaitemModel, toastr, Toolbar, Statusbar, pDatepicker, Tree, moment) {
    moment.locale('en');
        ...
        , toolbar: [
            ...
            , {
                'input': {
                    ...
                    addon: true,
                    icon: 'fa fa-calendar',
                    value: moment(SERVERDATE).format('YYYY-MM-DD')
                }
            }
        ]
        , statusbar: []
...
//                            self.render();
        ...
        , updatePrintButton: function () {
            var $printButton = $(".print-btn");
            var dates = '/stats/broadcastprint?type=' + $('[data-type=type]').val()
