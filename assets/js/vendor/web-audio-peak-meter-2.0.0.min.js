define([], function () {
    webAudioPeakMeter = function (e) {
        ...
        function n(e, n, r) {
            const a = -1 * n, o = Math.floor(t.dbFromFloat(e) * r / a);
        ...
        var r = {
            audioClipPath: function (e, t, n) {
                ...
                const { clientWidth: n, clientHeight: r } = e, { backgroundColor: a } = t, o = document.createElement("div");
                ...
                const { clientWidth: n, clientHeight: r } = e, { dbRange: a, dbTickSize: o, fontSize: l, borderSize: i, tickColor: s } = t, c = Math.floor(a / o), f = Array.from(Array(c).keys()).map((t => {
                ...
                const { gradient: r, borderSize: a } = t, { channelCount: o, vertical: l, meterWidth: i, meterHeight: s, meterTop: c, tickWidth: f } = n, h = Array.from(Array(o).keys()).map((() => {
                    const t = document.createElement("div");
                    return e.appendChild(t), t.style.position = "absolute", t
                }));
                if (l) {
                    const e = i / o - a, t = `linear-gradient(to bottom, ${r.join(", ")})`;
                    h.forEach(((n, r) => {
                        n.style.height = `${s}px`, n.style.width = `${e}px`, n.style.backgroundImage = t, n.style.top = `${c}px`, n.style.left = `${(e + a) * r + f + a}px`
                    }))
                } else {
                    const e = s / o - a, t = `linear-gradient(to left, ${r.join(", ")})`;
                    h.forEach(((n, r) => {
                ...
                const { backgroundColor: r, borderSize: a, maskTransition: o } = t, { channelCount: l, vertical: i, meterWidth: s, meterHeight: c, meterTop: f, tickWidth: h } = n, d = Array.from(Array(l).keys()).map((() => {
                    const t = document.createElement("div");
                ...
                const { borderSize: r, labelColor: a, fontSize: o } = t, { channelCount: l, vertical: i, meterWidth: s, meterHeight: c, tickWidth: f } = n, h = Array.from(Array(l).keys()).map((() => {
                    const t = document.createElement("div");
                ...
                return h
            }, maskSize: n, paintMeter: function e(r, a) {
                const { dbRange: o } = r, { tempPeaks: l, heldPeaks: i, channelMasks: s, textLabels: c, meterHeight: f, meterWidth: h, vertical: d } = a, u = d ? f : h;
                s.forEach(((e, t) => {
                    const r = n(l[t], o, u);
                    d ? e.style.height = `${r}px` : e.style.width = `${r}px`
                })), c.forEach(((e, n) => {
                    if (0 === i[n]) e.textContent = "-∞"; else {
        ...
        function o(e, t) {
            const n = [], r = 1 / (4 * t), a = Math.floor((e - 1) / 2);
            for (let o = -a; o <= a; o += 1) {
                const a = .54 + .46 * Math.cos(2 * Math.PI * o / e);
                let l = 0;
        ...
        function l(e, t) {
            const { lpfBuffer: n, lpfCoefficients: r, upsampleFactor: a } = t, o = [];
        ...
        var s = {
            findAudioProcBufferSize: function (e) {
                return [256, 512, 1024, 2048, 4096, 8192, 16384].reduce(((t, n) => Math.abs(n - e) < Math.abs(t - e) ? n : t))
            }, calculateLPFCoefficients: o, filterSample: l, audioOverSampleAndFilter: i, calculateTPValues: function (e, n) {
                const { lastChannelTP: r, channelCount: a } = n, { sampleRate: o } = e;
                if (r.length <= 0) {
                    t.log(`Initialing TP values for ${a}channels`), n.lastChannelTP = new Array(a).fill(0);
                    const e = Math.pow(10, -2), r = 1.7;
        ...
        var f = {
            createMeterNode: function (e, n, r = {}) {
                const a = Object.assign({}, c, r), { refreshEveryApproxMs: o } = a, { channelCount: l, sampleRate: i } = e, s = o / 1e3 * i * l, f = t.findAudioProcBufferSize(s), h = n.createScriptProcessor(f, l, l);
                return e.connect(h).connect(n.destination), h
            }, createMeter: function (e, t, n = {}) {
                const o = Object.assign({}, c, n), l = r.createContainerDiv(e, o), i = r.createTicks(l, o), { channelCount: f } = t;
                i.tempPeaks = new Array(f).fill(0), i.heldPeaks = new Array(f).fill(0), i.channelCount = f, i.channelBars = r.createBars(l, o, i), i.channelMasks = r.createMasks(l, o, i), i.textLabels = r.createPeakLabels(l, o, i), "true-peak" === o.audioMeterStandard && (i.lpfCoefficients = [], i.lpfBuffer = [], i.upsampleFactor = 4, i.lastChannelTP = [], i.decayFactor = .99999), t.onaudioprocess = e => function (e, t, n) {
                    const { inputBuffer: r } = e, { audioMeterStandard: o } = t;
                    let l = [];
